...
namespace
{
    ...
    echo "ContinuousPHP CLI Installer$n";
    echo "=============$n$n";
    ...
    $manifest = file_get_contents('https://continuousphp.github.io/cli/manifest.json');
    ...
    echo " - Downloading ContinuousPHP CLI v", Dumper::toString($item->version), "...$n";
    ...
    echo " - Making ContinuousPHP CLI executable...$n";

    @chmod($item->name, 0755);

    echo "{$n}ContinuousPHP CLI installed!$n";
